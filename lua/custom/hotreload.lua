-- Hotreload plugin for Neovim: Automatically reloads buffers when their underlying files change on disk.
-- Source: https://richardgill.org/blog/configuring-neovim-coding-agents
local M = {}
